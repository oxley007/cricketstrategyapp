...
class ExplainerImageTwo extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
        //sessionId: 1,
      ...
      <Container>
        <ImageBackground source={require('../../assets/ExplainerImageTwo.png')} style={styles.backgroundImageBg}>
          <Row style={{bottom: 0, position: 'absolute'}}>
            ...
            onPress={() => this.props.navigation.navigate('ExplainerImageThree', {
              gameId: gameId,
              displayId: displayId,
              }
            )} >
...
export default connect(mapStateToProps)(ExplainerImageTwo);
