...
class TooCloseToCall extends React.Component {
  constructor(props) {
  ...
  render() {
    ...
    return (
      ...
      <Col style={{height: 75, backgroundColor: '#FF69B4', alignItems: 'center', justifyContent: 'center', borderBottomWidth: 1, borderBottomColor: '#fff',}}>
        ...
        <Col style={{flex: 1,paddingLeft: 15, paddingRight: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FF69B4', marginTop: 20, borderRadius: 5, marginRight: 15, marginLeft: 15}}>
        <Row style={{alignItems: 'center', justifyContent: 'center', paddingTop: 10, paddingBottom: 10, opacity: 1,}}>
          <Text style={{width: '100%', color: '#fff', fontSize: 100, textAlign: 'center'}}>Too Close To Call. Not Out.</Text>
        </Row>
      </Col>
      </Content>
      </LinearGradient>
...
export default connect(mapStateToProps)(TooCloseToCall);
